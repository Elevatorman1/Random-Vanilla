...
public class MuddyPigModel<T extends MuddyPigEntity> extends EntityModel<T> {
    ...
    public MuddyPigModel() {
        ...
        head.setTextureOffset(2, 27).addBox(-1.0F, -11.0F, -5.0F, 3.0F, 2.0F, 0.0F, 0.0F, false);
        head.setTextureOffset(52, 3).addBox(-1.0F, -5.0F, -7.0F, 3.0F, 1.0F, 3.0F, 0.0F, false);
        head.setTextureOffset(0, 0).addBox(0.0F, -10.0F, -5.0F, 1.0F, 3.0F, 0.0F, 0.0F, false);
        head.setTextureOffset(0, 0).addBox(-1.0F, -8.0F, -5.0F, 3.0F, 3.0F, 0.0F, 0.0F, false);
        head.setTextureOffset(6, 27).addBox(1.0F, -12.0F, -5.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
        head.setTextureOffset(3, 30).addBox(-1.0F, -12.0F, -5.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
